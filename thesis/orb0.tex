...
and in fact we do use certain simple combinations of the derivative later on in
\Cref{thm:group_kernel_full}.
In any case, the code in the Appendix implements the derivatives in $O(1)$ runtime.
