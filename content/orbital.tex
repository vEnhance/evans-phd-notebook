...
\begin{claim}
  ...
  \[
    \mathbf{1}(\gamma, t, m) =
    \begin{cases}
      1 & \text{if } -r \le m+k \le v(1-d\bar d)+r \\
      0 & \text{otherwise.}
    \end{cases}
  \]
\end{claim}
\begin{proof}
  ...
  the condition is simply $-k+v(1-d \bar d)-m \geq -r$.
\end{proof}
...
\begin{align*}
  ...
  &= \kappa \Vol(t: n =0) \sum_{j=-r}^{v(1-d \bar d)+r} \Vol(t_1: m=j) q^{2j(s-1)} \\
  &= \kappa \left( 1 - \frac{q+1}{q^2} \right) \sum_{j=-r}^{v(1-d \bar d)+r}
  \left( q^{2j} \left( 1-q^{-2} \right) \right) q^{2j(s-1)} \\
  &= \kappa \left( 1 - \frac{q+1}{q^2} \right) \left( 1-q^{-2} \right)
  \sum_{j=-r}^{v(1-d \bar d)+r} q^{2js}.
\end{align*}
...
\begin{align*}
  ...
  &= \kappa \Vol(t: v(t)=-k) \sum_{j=-r-k}^{v(1-d \bar d)+r-k}
    \Vol(t_1: m=j) q^{s(2j+2k)-4k-2j} \\
  &= \kappa q^{2k} \left( 1 - q^{-2} \right) \sum_{j=-r-k}^{v(1-d \bar d)+r-k}
    \left( q^{2j} \left( 1-q^{-2} \right) \right) q^{s(2j+2k)-4k-2j} \\
  &= \kappa q^{2k} \left( 1 - q^{-2} \right) \sum_{j=-r-k}^{v(1-d \bar d)+r-k}
    \left( q^{2j} \left( 1-q^{-2} \right) \right) q^{s(2j+2k)-4k-2j} \\
  &= \kappa q^{-2k} \left( 1 - q^{-2} \right)^2
    \sum_{j=-r-k}^{v(1-d \bar d)+r-k} q^{2(j+k)s} \\
  &= \kappa q^{-2k} \left( 1 - q^{-2} \right)^2 \sum_{j=-r}^{v(1-d \bar d)+r} q^{2js} \\
  &= \kappa q^{-2k} \left( 1 - q^{-2} \right)^2 \sum_{j=-r}^{v(1-d \bar d)+r} q^{2js}.
\end{align*}
...
\begin{align*}
  &\phantom= \left( \left( 1 - \frac{q+1}{q^2} \right) \left( 1-q^{-2} \right)
    + q^{-2}(1-q^{-2})  \right) \kappa \sum_{j=-r}^{v(1-d \bar d)+r} q^{2js} \\
  &\phantom= \left( 1-q\inv \right) \left(1-q^{-2}  \right)
    \kappa \sum_{j=-r}^{v(1-d \bar d)+r} q^{2js} \\
  &= \kappa \sum_{j=-r}^{v(1-d \bar d)+r} q^{2js}.
\end{align*}
