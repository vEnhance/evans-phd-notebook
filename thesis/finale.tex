...
\[ \Int^\circ((g,u), 1_{K,r})
  = \Big\langle \mathcal{T}_{\mathbf{1}_K \otimes \mathbf{1}_{K, r}}
...
\begin{theorem}
  When $r \ge 1$ and $v(\Nm u) > 0$ we have
  \[
    \Int^\circ((g,u), 1_{K,r})
    =
    \begin{cases}
...
\begin{proof}
  ...
  \[ C = \frac{v(b) + v(c)- 2v(d-a) - 1}{2} \ge 0 \]
  in the first case.
  Then \eqref{eq:int_circle_orbital_param} follows by translating back.
\end{proof}
