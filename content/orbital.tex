...
Therefore, the orbital integral can be expressed succincitly in the following way.
\begin{theorem}
  [Orbital integral in the odd case]
  Under the assumptions before, the orbital integral is given by
  \[
    O(\gamma, \mathbf{1}_{\Omega_r}, s)
    = \sum_{k \in \ZZ}
  ...
  \[
    ...
    \begin{cases}
      ...
      r + \left\lfloor \frac{\ell}{2} \right\rfloor & \text{if } \ell - r \le k < 2\delta + r \\
