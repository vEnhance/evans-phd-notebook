...
\begin{theorem}
  ...
  \[
    ...
    \begin{cases}
      ...
      r + \frac{\ell-1}{2} & \text{if } \ell - r \le k \le 2\delta + r \\
...
If $\ell$ is even, we have a similar intermediate result.
\begin{proposition}
  Suppose $\ell$ is even.
  ...
  \[
    ...
    \begin{cases}
      k + 2r & \text{if } {-2r} \le k \le -r \\
      r + \left\lfloor \frac{k+r}{2} \right\rfloor & \text{if }{-r} \le k \le \ell-r \\
      r + \frac{\ell}{2} - (k-r)\%2 & \text{if } \ell - r \le k \le 2\delta + r \\
      r + \left\lfloor \frac{(2\delta+\ell+r)-k}{2} \right\rfloor & \text{if } 2\delta + r \le k \le 2\delta + \ell + 3r
    \end{cases}
  \]
  ...
  \[
    ...
    \begin{cases}
      k + 2r & \text{if } {-2r} \le k \le -r \\
      r + \left\lfloor \frac{k+r}{2} \right\rfloor & \text{if }{-r} \le k \le \ell-r \\
      r + \left\lfloor \frac{\ell}{2} \right\rfloor - (k-r) \% 2 & \text{if } \ell - r \le k \le 2\delta + r \\
      r + \left\lfloor \frac{(2\delta+\ell+r)-k}{2} \right\rfloor & \text{if } 2\delta + r \le k \le 2\delta + 2\lambda - \ell + r \\
