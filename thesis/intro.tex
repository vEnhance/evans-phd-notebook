...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    The notion of regular semisimple is defined in \Cref{ch:matching}.)
  ...
  \begin{itemize}
    ...
    is itself defined in \Cref{ch:orbital0}.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    This matching is defined in \Cref{ch:matching}.
...
\begin{conjecture}
  ...
  Then for matching (as defined in \Cref{ch:matching}) regular semisimple elements
  ...
  while the orbital integral $\Orb(\dots)$ is defined in \Cref{ch:orbitalFJ0}.
\end{conjecture}
...
where $V_n'(F)$ (defined in \Cref{ch:background})
consists of pairs of column vectors and row vectors of length $n$,
and the space $\VV_n$ is defined in \Cref{ch:matching}.
The notion of \emph{matching} is defined in \Cref{ch:matching} as well.
...
\begin{conjecture}
  ...
  where the intersection number $\Int(\dots)$ and
  the transfer factor $\omega$ are defined in \Cref{ch:geo}
  while the orbital integral $\Orb(\dots)$ is defined in \Cref{ch:orbital0}.
...
\begin{itemize}
  ...
  Further background is stated in \Cref{ch:matching},
