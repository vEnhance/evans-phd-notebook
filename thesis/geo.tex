...
\section{Euler-Poincar\'{e} characteristic}
...
\section{Intersection number for the group version of AFL}
\begin{definition}
...
\section{Intersection number for the semi-Lie version of AFL}
In what follows, let
