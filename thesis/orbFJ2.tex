...
\section{Proof of \Cref{thm:semi_lie_derivative_single}}
...
now at $s = 0$, thus proving \Cref{thm:semi_lie_derivative_single}.
...
\end{align*}
These formulas match \Cref{thm:semi_lie_derivative_single}, proving it.
...
as a corollary of \Cref{thm:semi_lie_derivative_single}.
Observe that when we add the right-hand side of \Cref{thm:semi_lie_derivative_single}
