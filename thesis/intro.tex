...
Part (a) of \Cref{conj:kernel_semi_lie} implies that the map
\begin{align*}
...
\begin{restatable}[$\partial\Orb \colon \HH(S_3(F)) \to C^\infty(S_3(F)\rs^-)$ has large image]{theorem}{nogroupkernel}
