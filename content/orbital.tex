...
\begin{equation}
  ...
  \label{eq:ell}
\end{equation}
We will also define one additional parameter
\begin{equation}
  \lambda \coloneqq v(1-u \bar u)
  \label{eq:lambda}
\end{equation}
In the case where $\ell$ is odd, it will turn out that $\lambda = \ell$
and this definition will never be used --- the orbital will be computed
as a function of $\ell$ and $\delta$ (and $r$).
However for even $\ell$ these numbers are not necessarily equal and our orbital
