...
\begin{theorem}
  There is no nonzero function $\varphi \in \HH(S_2(F))$ such that
  \[
    \left. \pdv{}{s} \right\rvert_{s=0}
    \Orb(
    , \varphi \otimes \oneV, s)
    = 0
  \]
  holds for every $i \ge 0$.
\end{theorem}
...
\begin{theorem}
  ...
  \end{itemize}
\end{theorem}
\todo{okay lol it's not even true}
