...
In this case, \Cref{thm:semi_lie_combo} implies that
\begin{align*}
...
In the case where $r = 0$ we refer to \Cref{prop:semi_lie_derivative_single}
...
In this case, \Cref{thm:semi_lie_combo} gives
\begin{align*}
  \frac{(-1)^{r+v(c)}}{\log q}\partial\Orb(r, v(b), v(c), v(e), v(d-a))
