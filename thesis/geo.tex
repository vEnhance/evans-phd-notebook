...
\begin{itemize}
  ...
  \ii A third object $\mathcal Z(u)$, the KR-divisor, corresponding to diagrams
  \begin{center}
  \begin{tikzcd}
    \ol{\mathcal{E}}\ar[r] \ar[d, dash] & \mathcal{X}_n \ar[d, dash] \\
    \EE \ar[r, "u"] & \XX_n.
...
see \cite[equation (4.6)]{ref:survey}.\todo{Should be $\RZ_{n,n}$ right?
  Not $\RZ_n$, like in (4.6) of the survey.}

\paragraph{The analytic side}
On the other hand, consider the analytic side.
We will try to explain how the orbital integral in \Cref{def:orbitalFJ}
...
If you squint hard enough, the orbital integral we defined in \Cref{def:orbitalFJ}
