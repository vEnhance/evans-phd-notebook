...
\begin{align*}
  ...
  &= \kappa \sum_{n=1}^{\min(2\ell,\delta)+r}
...
\begin{itemize}
  ...
  The constraints for $n$ are that $n \ge 1$, $n \le \min(2\ell, \delta)+r$,
...
\[
  ...
  \sum_{n=1}^{\min(2j-1-r, \min(2\ell,\delta)+r)}
  q^{\left\lfloor \frac{n+r}{2} \right\rfloor} \cdot (-1)^n q^{s(n+2\delta+2r-2j)}
  + \sum_{j=0}^{\left\lfloor \frac{\ell}{2} \right\rfloor+r}
