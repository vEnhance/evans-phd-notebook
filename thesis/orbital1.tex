...
\section{Case analysis when $v(b) = 0$}
...
For the most part the cases where $v(b) \neq 0$ have to then be handled separately.
...
\subsection{Analysis of Case 3 and 4 assuming $n > 0$ and $v(b) = 0$.}
...
\end{align*}
Moreover, in any situtaion where $v(d) > 0$, we have $\ell = \delta = 0$,
