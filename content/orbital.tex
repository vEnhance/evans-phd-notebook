...
\begin{equation}
  1-r \le m \le \left\lfloor \frac{\min(\ell,2\delta)}{2} \right\rfloor+r+\delta
  \qquad 2m-2\delta-r-1 \le n \le r + \min(m, \ell, 2\delta).
  \label{eq:odd_range1}
\end{equation}
...
\begin{equation}
  \left\lceil \frac{1+r}{2} \right\rceil + \delta + 1 \le m \le \ell + r + \delta
  \qquad \max(1, m-r-\delta) \le n \le
  \label{eq:odd_range2}
\end{equation}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &= \kappa q^{-2k} \left( 1 - q^{-2} \right)^2 \sum_{m=-r}^{\delta+r} q^{2ms} \\
    &= \kappa q^{-2k} \left( 1 - q^{-2} \right)^2 \sum_{m=-r}^{\delta+r} q^{2ms}.
  \end{align*}
  ...
  \begin{align*}
    &\phantom= \left( \left( 1 - \frac{q+1}{q^2} \right) \left( 1-q^{-2} \right)
      + q^{-2}(1-q^{-2})  \right) \kappa \sum_{m=-r}^{\delta+r} q^{2ms} \\
    &= \left( 1-q\inv \right) \left(1-q^{-2} \right)
      \kappa \sum_{m=-r}^{\delta+r} q^{2ms} \\
    &= \sum_{m=-r}^{\delta+r} q^{2ms}. \qedhere
  \end{align*}
\end{proof}
