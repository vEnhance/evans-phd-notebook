...
\end{lemma}
\begin{proof}
  \todo{inline the previous three facts}
\end{proof}
...
\begin{equation}
  ...
  \label{eq:odd_disk2}
\end{equation}
Use \Cref{fact:mastercard} on \eqref{eq:odd_disk1} and \eqref{eq:odd_disk2},
...
\begin{itemize}
  ...
  then \Cref{lem:volume} and \Cref{fact:mastercard} apply if and only if, respectively,
  \begin{align}
