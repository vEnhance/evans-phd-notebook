...
\begin{example}
  ...
  the right-hand side of \Cref{thm:semi_lie_combo} equals
  \[ 23q^{13} + q^{12} + q^{11} + q^{10} + q^9 + \dots + q + 1. \]
\end{example}

\begin{example}
  When $r = 6$, $v(b) = 10$, $v(c) = 5$, $v(e) = 7$, $v(d-a) > v(e)-r = 1$,
  the right-hand side of \Cref{thm:semi_lie_combo} equals
  \[ -(q^7 + q^6 + q^5 + \dots + q + 1). \]
\end{example}

\begin{example}
  When $r = 8$, $v(b) = -101$, $v(c) = 1000$, $v(e) = 29$, $v(d-a) = 11$,
  the right-hand side of \Cref{thm:semi_lie_combo} equals
  \[ 444 q^{19} + 445q^{18} + q^{17} + q^{16} + q^{15} + \dots + q + 1. \]
\end{example}
