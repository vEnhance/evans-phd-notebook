...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    This module $\HH(S_n(F), K')$ is defined in \Cref{ch:background}.
  ...
  \begin{itemize}
    ...
    This base change is defined and then calculated explicitly in \Cref{ch:satake}.
  \end{itemize}
\end{itemize}
...
\begin{conjecture}
  ...
  while the orbital integral $\Orb(\dots)$ is defined in \Cref{def:orbital0}.
\end{conjecture}
...
and the space $\VV_n$ is defined in \Cref{def:VV_n}.
...
\begin{conjecture}
  ...
  while the orbital integral $\Orb(\dots)$ is defined in \Cref{def:orbitalFJ}.
...
\section{Results}
One primary objective of this paper is to fully determine the orbital integral
...
\begin{itemize}
  ...
  \ii The case $n = 2$ of semi-Lie verison of the AFL (\Cref{conj:semi_lie_spherical}).
\end{itemize}
...
We were able to successfully calculate this orbital integral for all these cases.
The result is too involved to state in the introduction,
but we give the following summary.
\begin{theorem}
  For $\gamma \in S_3(F)\rs$ and $\phi \in \HH(S_3(F), K')$
  (resp.\ $\guv \in (S_2(F) \times V'_2(F))\rs$ and $\phi \in \HH(S_3(F), K')$)
  the orbital integral $\Orb(\gamma, \phi, s)$
...
\begin{itemize}
  ...
  \ii In \Cref{ch:orbital0} we introduce the orbital integral
  ...
  \ii In \Cref{ch:orbitalFJ0} we introduce the orbital integral
