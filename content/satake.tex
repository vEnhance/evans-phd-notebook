...
\begin{proposition}
  ...
  \begin{align*}
    &r_\ast(\mathbf{1}_{\Mat_3(\OO_E), v\circ\det=r}) \\
    &= \sum_{j=0}^r \left(
...
\begin{proof}
  ...
  \[
    r_\ast(\mathbf{1}_{\Mat_3(\OO_E), v\circ\det=r})(g\bar{g})
  ...
  \begin{align*}
    ...
    k.
  \end{align*}
  Hence, we can rewrite the $r_\ast(\mathbf{1}_{\Mat_3(\OO_E), v\circ\det=r})$
...
\begin{align*}
  ...
  \intertext{so}
  &r_\ast(f'_r -q^2 f'_{r-1} + q \left( f'_{r-1} - q^2 f'_{r-3} \right)) \\
