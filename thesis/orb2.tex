...
\begin{align*}
  ...
  q^j \cdot (-1)^n q^{s(n+2\delta+2r-2j)} \\
  &= \sum_{j=\max(r-(\lambda-\ell-1),0)}^{r} \sum_{n=\ell+r+1}^{\lambda+j}
  q^j \cdot (-1)^n q^{s(n+2\delta+2r-2j)}
...
\begin{align*}
  \sum_{j=0}^{-2|v(d)|+r-1}
    \sum_{n=j+1}^{\min(j+\lambda, -2|v(d)| + r)}
    q^j \cdot (-1)^n q^{s(n-4|v(d)|+2r-2j)} \\
  + \sum_{j=0}^{-|v(d)|+r-1}
    \sum_{n=\max(j+1, -2|v(d)|+r+1)}^{\min(j+\lambda,-|v(d)|+r)}
    q^j (-1)^n q^{s(n-4|v(d)|+2r-2j)} \\
  +\sum_{j=\max(0, -|v(d)|+r+1 -\lambda)}^{-|v(d)|+r-1}
    \sum_{n=-|v(d)|+r+1}^{\lambda+j}
    q^j (-1)^n q^{s(n-4|v(d)|+2r-2j)}.
\end{align*}
Let $k = n - 4|v(d)| + 2r - 2j$ and transform this into
\begin{align*}
  \sum_{j=0}^{-2|v(d)|+r-1}
    \sum_{k=-4|v(d)|+2r-j+1}^{\min(j+\lambda, -2|v(d)| + r)-4|v(d)|+2r-2j}
    q^j (-q^s)^k \\
  + \sum_{j=0}^{-|v(d)|+r-1}
    \sum_{k=\max(j+1, -2|v(d)|+r+1) - 4|v(d)| + 2r - 2j}^{\min(j+\lambda,-|v(d)|+r) - 4|v(d)| + 2r - 2j}
    q^j (-q^s)^k \\
  +\sum_{j=\max(0, -|v(d)|+r+1 -\lambda)}^{-|v(d)|+r-1}
    \sum_{k=-5|v(d)|+3r-2j+1}^{\lambda-j-4|v(d)|+2r}
    q^j (-q^s)^k.
\end{align*}
...
\subsubsection{Case where $r \le 2|v(d)|$ and $\lambda \ge |v(d)|+r$}
Resolving the minimums and maximums:
\begin{align*}
  \Orb(\gamma, \mathbf{1}_{K'_{S, \le r}}, s)
  &= \sum_{j=0}^{-|v(d)|+r-1} \sum_{k = j - 2r}^{-j - 4|v(d)| + 2r} q^j (-q^s)^k
  + q^{-|v(d)|+r} \sum_{\substack{-|v(d)|-r \le k \le -3|v(d)|+r \\ k \equiv -|v(d)|+r \bmod 2}}
  ...
  \bigg( \min\left( \left\lfloor \frac{k+\lambda-|v(d)|+r}{2} \right\rfloor, k+r \right) \\
    ...
    (-q^s)^k \\
  &+ \sum_{j=0}^{-|v(d)|+r-1}
    \sum_{k=(j+1) - 4|v(d)| + 2r - 2j}^{(-|v(d)|+r) - 4|v(d)| + 2r - 2j}
    q^j (-q^s)^k \\
  &+ \sum_{j=0}^{-|v(d)|+r-1}
    \sum_{k=-5|v(d)|+3r-2j+1}^{\lambda-j-4|v(d)|+2r}
    q^j (-q^s)^k.
\end{align*}
Several of the sums collapse together and we are left with just
\begin{align*}
  \Orb(\gamma, \mathbf{1}_{K'_{S, \le r}}, s)
  &= \sum_{j=0}^{-|v(d)|+r-1} \sum_{k = j - 2r}^{\lambda-j-4|v(d)|+2r} q^j (-q^s)^k
  + \sum_{\substack{-|v(d)|-r \le k \le -3|v(d)|+r \\ k \equiv -|v(d)|+r \bmod 2}}
    q^{-|v(d)|+r} (-q^s)^k \\
  &+ q^{-|v(d)|+r}  \sum_{k=-|v(d)|-r+1}^{\lambda-3|v(d)|+r}
  \bigg( \min\left( \left\lfloor \frac{k+\lambda-|v(d)|+r}{2} \right\rfloor, k+r \right) \\
...
\subsubsection{Case where $r \le 2|v(d)|$}
\begin{align*}
  \Orb(\gamma, \mathbf{1}_{K'_{S, \le r}}, s)
  &= \sum_{j=0}^{-|v(d)|+r-1} \sum_{k = j - 2r}^{-j - 4|v(d)| + 2r} q^j (-q^s)^k
  + q^{-|v(d)|+r} \sum_{\substack{-|v(d)|-r \le k \le -3|v(d)|+r \\ k \equiv -|v(d)|+r \bmod 2}}
  ...
  \bigg( \min\left( \left\lfloor \frac{k+\lambda-|v(d)|+r}{2} \right\rfloor, k+r \right) \\
    ...
    (-q^s)^k \\
  &+ \sum_{j=0}^{-|v(d)|+r-1}
    \sum_{k=(j+1) - 4|v(d)| + 2r - 2j}^{\min(j+\lambda,-|v(d)|+r) - 4|v(d)| + 2r - 2j}
    q^j (-q^s)^k \\
  &+ \sum_{j=\max(0, -|v(d)|+r+1 -\lambda)}^{-|v(d)|+r-1}
    \sum_{k=-5|v(d)|+3r-2j+1}^{\lambda-j-4|v(d)|+2r}
    q^j (-q^s)^k.
