...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{align*}
      ...
      &= k - (\ell-r) + (k+r) \% 2.
    \end{align*}
    \ii If $k \ge \lambda - r$, then we require $\lambda \le \frac{\ell}{2} + \delta$.
    This means $\frac{\ell}{2} + \delta - r \ge \lambda - \frac{\ell}{2} + \delta$ must hold.
    \begin{align*}
